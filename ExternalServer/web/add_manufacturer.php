               ...
               <div class="row">
                   <?php 
                        if (isset($_REQUEST['msg']))
						{
				   		...
				   		$manufacturer_list = decode_data(api_call('include_inactive=yes', "list_manufacturers"));
                   ?>
...
<?php
    ...
    {	
		...
		if(!safe_input($manufacturer)){
			...
			$result = decode_status(api_call("manufacturer=$manufacturer", "add_manufacturer"));
		}
